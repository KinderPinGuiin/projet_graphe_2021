...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.linesList.setSelectionMode(
        ...
        self.nodesList.setSelectionMode(
            QtWidgets.QAbstractItemView.NoSelection)
        ...
        self.gridLayout_4.addWidget(
            self.label_3, 0, 0, 1, 1, QtCore.Qt.AlignHCenter)
        self.label_8 = QtWidgets.QLabel(self.gridGroupBox_2)
        self.label_8.setObjectName("label_8")
        self.gridLayout_4.addWidget(
            self.label_8, 1, 0, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_6.addWidget(
            self.gridGroupBox_2, 0, 0, 1, 1, QtCore.Qt.AlignVCenter)
        ...
        self.formLayout.setWidget(
            0, QtWidgets.QFormLayout.LabelRole, self.label_5)
        ...
        self.formLayout.setWidget(
            0, QtWidgets.QFormLayout.FieldRole, self.nameDisplay)
        ...
        self.formLayout.setWidget(
            1, QtWidgets.QFormLayout.FieldRole, self.firstnameDisplay)
        ...
        self.formLayout.setWidget(
            2, QtWidgets.QFormLayout.FieldRole, self.ageDisplay)
        self.verticalLayout_10.addWidget(
            self.formGroupBox, 0, QtCore.Qt.AlignVCenter)
        ...
        self.gridLayout_6.addWidget(
            self.verticalGroupBox3, 1, 0, 1, 1, QtCore.Qt.AlignVCenter)
        ...
        self.formLayout_2.setWidget(
            0, QtWidgets.QFormLayout.FieldRole, self.namePageDisplay)
        ...
        self.userRadio.toggled['bool'].connect(
            self.firstnameFrame.show)  # type: ignore
        self.userRadio.toggled['bool'].connect(
            self.ageFrame.show)  # type: ignore
        self.userRadio.toggled['bool'].connect(
            self.adminFrame.hide)  # type: ignore
        self.pageRadio.toggled['bool'].connect(
            self.firstnameFrame.hide)  # type: ignore
        self.pageRadio.toggled['bool'].connect(
            self.ageFrame.hide)  # type: ignore
        self.pageRadio.toggled['bool'].connect(
            self.adminFrame.show)  # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.adminListSearch.setPlaceholderText(
            _translate("MainWindow", "Filtrer ..."))
        ...
        self.nodesSortCombo.setItemText(
            0, _translate("MainWindow", "-- Trier par --"))
        self.nodesSortCombo.setItemText(
            1, _translate("MainWindow", "Nom croissant"))
        self.nodesSortCombo.setItemText(
            2, _translate("MainWindow", "Nom décroissant"))
        self.nodesSortCombo.setItemText(
            3, _translate("MainWindow", "Degré croissant"))
        self.nodesSortCombo.setItemText(
            4, _translate("MainWindow", "Degré décroissant"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.graphTab), _translate("MainWindow", "Graphe"))
        ...
        self.verticalGroupBox_3.setTitle(_translate(
            "MainWindow", "Page(s) administrée(s)"))
        self.verticalGroupBox2.setTitle(_translate(
            "MainWindow", "Gérer les arcs vers les sommets"))
        self.deleteLineCombo.setItemText(
            0, _translate("MainWindow", "-- Sélectionner --"))
        self.deleteLineButton.setText(_translate("MainWindow", "Supprimer"))
        self.nodeCombo.setItemText(0, _translate(
            "MainWindow", "-- Sélectionner --"))
        self.addLineButton.setText(_translate("MainWindow", "Ajouter"))
        self.verticalGroupBox3.setTitle(_translate(
            "MainWindow", "Sélectionner un Utilisateur"))
        self.userCombo.setItemText(0, _translate(
            "MainWindow", "-- Sélectionner --"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.usersTab), _translate("MainWindow", "Utilisateurs"))
        ...
        self.verticalGroupBox_4.setTitle(
            _translate("MainWindow", "Administateurs :"))
        self.verticalGroupBox_5.setTitle(
            _translate("MainWindow", "Sélectionner une page"))
        self.pageCombo.setItemText(0, _translate(
            "MainWindow", "-- Sélectionner --"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.PagesTab), _translate("MainWindow", "Pages"))
        self.menuFichier.setTitle(_translate("MainWindow", "Fichier"))
        self.actionCharger_un_graphe.setText(
            _translate("MainWindow", "Charger un graphe"))
        ...
        self.actionSauvegarder.setText(
            _translate("MainWindow", "Sauvegarder..."))
