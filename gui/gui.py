...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(50, 10, 161, 431))
        ...
        self.pageRadio.toggled['bool'].connect(self.adminFrame.show)
        self.userRadio.toggled['bool'].connect(self.ageFrame.show)
        self.pageRadio.toggled['bool'].connect(self.ageFrame.hide)
        self.userRadio.toggled['bool'].connect(self.adminFrame.hide)
        self.userRadio.toggled['bool'].connect(self.firstnameFrame.show)
        self.pageRadio.toggled['bool'].connect(self.firstnameFrame.hide)
